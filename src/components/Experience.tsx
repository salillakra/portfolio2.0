          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-[var(--border)] bg-[var(--badge-bg)]">
              ...
              <span className="text-xs font-medium text-[var(--text-tertiary)] border border-[var(--border)] rounded-full px-3 py-1 w-max">
                {job.period}
              </span>
            </div>
            ...
            <ul className="space-y-2.5 text-sm text-[var(--text-secondary)]">
              {job.highlights.map((item) => (
                <li key={item} className="flex items-start gap-2">
                  <span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-[var(--text-tertiary)]" />
                  {item}
                </li>
              ))}
            </ul>
