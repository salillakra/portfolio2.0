...
export const meta = {
  ...
  coverImage:
    "https://images.unsplash.com/photo-1775519520461-6b6e068d9250?auto=format&fit=crop&w=1600&q=80",
  coverImageAlt: "Server rack infrastructure representing production database systems",
}
...
<BlogDiagram
  variant="database-migration"
  title="Expand-contract migration rollout timeline"
  caption="Zero-downtime migrations work best as a staged rollout: expand safely, write both shapes, backfill in chunks, shift reads after verification, then contract."
/>
