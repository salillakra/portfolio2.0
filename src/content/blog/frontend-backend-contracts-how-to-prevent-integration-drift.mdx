...
export const meta = {
  ...
  coverImage:
    "https://images.unsplash.com/photo-1743090661053-3d1feb2beab7?auto=format&fit=crop&w=1600&q=80",
  coverImageAlt: "Typed source code on a screen representing API contract definitions",
}
...
<BlogDiagram
  variant="contract-drift"
  title="Shared schema workflow for preventing integration drift"
  caption="Contract drift is reduced when frontend expectations, backend responses, and CI checks all converge on the same executable schema artifact."
/>
