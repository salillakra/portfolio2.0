...
export const meta = {
  ...
  coverImage:
    "https://images.unsplash.com/photo-1763568258179-fa561d623323?auto=format&fit=crop&w=1600&q=80",
  coverImageAlt: "Production monitoring and code screens for backend API systems",
}
...
<BlogDiagram
  variant="api-reliability"
  title="Reliable API request boundary with fallback paths"
  caption="Reliable APIs define request behavior at the boundary, route fragile work through durable paths, and return stable outcomes even when downstream systems vary."
/>
